...
import StyledFinExtensionsTextOverrideWrapper from './styles';
...
function FinExtensionsTextOverride(props: FinExtensionsTextOverrideProps) {
  const {
    getPConnect,
    value,
    disabled = false,
  ...
  if (displayMode === 'LABELS_LEFT' || displayMode === 'DISPLAY_ONLY') {
    ...
    return displayMode === 'DISPLAY_ONLY' ? (
      <StyledFinExtensionsTextOverrideWrapper>
        {' '}
        {displayComp}{' '}
      </StyledFinExtensionsTextOverrideWrapper>
    ) : (
...
export default withConfiguration(FinExtensionsTextOverride);
